...
import PartCard from "@/components/modules/part/part";
    ...
    <>
      ...
      <BFContainer>
        <div className="px-5 py-10">
          ...
          <p>
            Car Repair 360 BD - The best car service center in Dhaka providing
            ...
            multi-brand car workshop for you. Entrust your prized automobile
            with Bangladesh’s #1 car repair shop Car Repair 360 Automobiles BD.
            Call +8801742700300 today.
          </p>
        </div>
        <div className="px-5 py-10">
          <h2 className="mb-4 text-4xl">
            Premium Car servicing center near you
          </h2>
          <p>
            Car Repair 360 Automobiles BD is a leading car servicing center in
            Dhaka. Established in 2015, we have over 09 years of experience
            serving customers with all their automobile needs. Our
            state-of-the-art facilities and expert technicians enable us to
            provide trusted, reliable, and satisfactory services for vehicles of
          ...
          <p>
            ...
            replacements; detailing, and more. We use high-quality spare parts
            and accessories for optimum performance and longevity of vehicles.
          </p>
        </div>
      </BFContainer>
            ...
            <div className="grid grid-col-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <h2 className="text-4xl font-semibold">
                  Car Repair 360 Automobiles BD - Premium auto repair services
                  near Dhaka City
                </h2>
                <p className="mt-10">
                  ...
                  We have the latest diagnostic tools for in-depth vehicle
                  health checks and precision car repair services.
                </p>
                <p className="mt-4">
                ...
                <p className="mt-4">
                  ...
                  and satisfaction motivate us to keep raising the bar on our
          ...
          <div className="grid grid-col-1 md:grid-cols-2 gap-4">
            ...
            <div className="order-1">
              ...
              <p className="mt-4">
                ...
                smiles and satisfaction motivate us to keep raising the bar on
                our car repair services every single day.
              </p>
            </div>
          </div>
        </div>
